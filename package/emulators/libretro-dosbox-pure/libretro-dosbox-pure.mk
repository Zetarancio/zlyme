...
# ROCKNIX/Batocera: this core misbehaves at -O3.
LIBRETRO_DOSBOX_PURE_CFLAGS = $(filter-out -O3,$(TARGET_CFLAGS)) -O2
LIBRETRO_DOSBOX_PURE_CXXFLAGS = $(filter-out -O3,$(TARGET_CXXFLAGS)) -O2
...
define LIBRETRO_DOSBOX_PURE_BUILD_CMDS
	$(TARGET_CONFIGURE_OPTS) CFLAGS="$(LIBRETRO_DOSBOX_PURE_CFLAGS)" \
		CXXFLAGS="$(LIBRETRO_DOSBOX_PURE_CXXFLAGS)" \
