...
# libretro-ecwolf
################################################################################
# Version: porschemad911 fork (sdl-submodule-url). Upstream libretro/ecwolf
# still points SDL/mixer/net at Bitbucket (401 here). Revert after
# https://github.com/libretro/ecwolf/pull/102 merges.
LIBRETRO_ECWOLF_VERSION = 5ddc1d0000df81a92378da2514da91e06de67922
LIBRETRO_ECWOLF_SITE = https://github.com/porschemad911/ecwolf
