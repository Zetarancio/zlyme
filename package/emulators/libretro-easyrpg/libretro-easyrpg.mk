...
# libretro-easyrpg
#
# Knulli package/batocera/emulators/retroarch/libretro/libretro-easyrpg
# (Player 0.8.1, cmake -DPLAYER_TARGET_PLATFORM=libretro).
################################################################################
...
LIBRETRO_EASYRPG_CONF_ENV += LDFLAGS="-lpthread -fPIC" CFLAGS="-fPIC" CXXFLAGS="-fPIC"
