...
# CMake 4 sets CMAKE_PARENT_LIST_FILE in -P script mode, so embed-binaries
# never writes the generated .c/.h (silent no-op).
define LIBRETRO_MELONDS_DS_FIX_EMBED_CMAKE4
	$(SED) 's/if(CMAKE_SCRIPT_MODE_FILE AND NOT CMAKE_PARENT_LIST_FILE)/if(CMAKE_SCRIPT_MODE_FILE)/' \
		$(@D)/buildroot-build/_deps/embed-binaries-src/cmake/embed-binaries.cmake
endef
LIBRETRO_MELONDS_DS_PRE_BUILD_HOOKS += LIBRETRO_MELONDS_DS_FIX_EMBED_CMAKE4
