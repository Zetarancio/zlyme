...
- **Settings → System → Joysticks** — stick test, manual calibration, live deadzone, and Rumble Strength. Rumble Strength is the physical motor gain. **Settings → System → Haptic feedback** only turns NextUI's own pulses on or off. The calibration workflow is based in part on Joe's Calibrage by Kevin Vranken, MIT.
